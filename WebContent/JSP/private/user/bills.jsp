			  ...
			  <table class="table table-striped">
			    ...
			    <tbody>
			      <tr>
			        ...
			        <td><a href="#" class="btn btn-danger" role="button">Cancelar</a></td>
			      </tr>
			      <tr>
			        <td>Cell</td>
			        <td>Cell</td>
			        <td>Cell</td>
			        <td>Cell</td>
			        <td><a href="#" class="btn btn-outline-secondary">Ver Detalle</a></td>
			        <td><a href="#" class="btn btn-outline-success disabled" role="button" aria-disabled="true">Entregado</a></td>
			      </tr>
			      <tr>
			        <td>Cell</td>
			        <td>Cell</td>
			        ...
			        <td>Cell</td>
			        <td><a href="#" class="btn btn-outline-secondary">Ver Detalle</a></td>
			        <td><a href="#" class="btn btn-outline-info disabled" role="button" aria-disabled="true">Procesado</a></td>
			      </tr>
			    </tbody>
			  </table>
			</div>
