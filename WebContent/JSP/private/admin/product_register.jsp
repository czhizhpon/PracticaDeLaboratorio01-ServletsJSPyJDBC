			...
			<div class="row">
				<form action="" class="text-left form col-12">
					...
					<div class="form-group ">
						...
						<input type="number" id="pro_stock" name="pro_stock" class="form-control" placeholder="0" min="0" step="1">	
					</div>
					<div class="form-group ">
						<label for="pro_price">Precio:</label>
						<input type="number" id="pro_price" name="pro_price" class="form-control" placeholder="0.00" min="0.00" step=".01">	
					</div>
					<div class="form-group ">
